                                    ...
                                    <div class="media">
                                        <div class="avatar-xs me-3">
                                            <span class="avatar-title bg-primary rounded-circle font-size-16">
                                                <img src="{{ asset('admin/images/logo_sca.png') }}"
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    @if (session()->get('usuario')['admin'])
                        <div class="px-3">
                            <form id="form-select-academia" action="{{ route('painel.academia.selecionar') }}"
                                method="post">
                                @csrf
                    ...
                    <ul class="metismenu list-unstyled mt-3" id="side-menu">
                        @if (session()->get('usuario')['admin'] == 0 || session()->get('academia'))
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    @if (session()->get('academia'))
                                        <li><a href="{{ route('painel.academia.getree.relatorio', ['academia' => session()->get('academia')]) }}"
                                                key="t-default">Getree</a></li>
                                    @else
                                        <li><a href="{{ route('painel.academia.getree.relatorio', ['academia' => session()->get('usuario')['academia_id']]) }}"
                                                key="t-default">Getree</a></li>
                                    @endif
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('painel.administracao.lancamento') }}"
                                            key="t-default">Checklist</a></li>
                                    <li><a href="{{ route('painel.administracao.jornada') }}"
                                            key="t-default">Jornada</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('calendario.intervencoes') }}"
                                            key="t-default">Intervenções</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    @foreach (config('videos.categorias') as $key => $categoria)
                                        <li><a href="{{ route('painel.videos.exibir', ['slug' => config('videos.slug')[$key]]) }}"
                                                key="t-default">{{ config('videos.categorias')[$key] }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        ...
                        @if (session()->get('usuario') && session()->get('usuario')['admin'] && !session()->get('academia'))
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('painel.configuracoes.grupos') }}"
                                            key="t-default">Gerenciamento</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('painel.configuracoes.jornada.atividades') }}"
                                            key="t-default">Gerenciamento</a></li>
                                </ul>
                            </li>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4 lista-atualizacoes">
                ...
                <ul class="">
                    <li><i class="fa fa-plus" aria-hidden="true" style="color: green;"></i> <span>Adição de sistema
                            de jornadas.</span></li>
                ...
                <ul class="">
                    <li><i class="fa fa-plus" aria-hidden="true" style="color: green;"></i> <span>Adição da
                            visualização de leads.</span></li>
                ...
                <ul class="">
                    <li><i class="fa fa-plus" aria-hidden="true" style="color: green;"></i> <span>Adição do sistema
                            de calendário de intervenções.</span></li>
                ...
                <ul class="">
                    <li><i class="fa fa-plus" aria-hidden="true" style="color: green;"></i> <span>Adição do sistema
                            de nível para a academia.</span></li>

                </ul>

                <h6 class="text-left mb-3 mt-4">25/02/2021 - V 1.1</h6>
                <ul class="">
                    <li><i class="fas fa-sync-alt" style="color: #dab600;"></i> <span>Atualizando dashboard de
                            checklist para conter informações por grupo.</span></li>
                ...
                <ul class="">
                    <li><i class="fa fa-plus" aria-hidden="true" style="color: green;"></i> <span>Adição do sistema
                            de lançamento de atividades.</span></li>
                    <li><i class="fa fa-plus" aria-hidden="true" style="color: green;"></i> <span>Adição da
                            dashboard de checklist.</span></li>
                </ul>
