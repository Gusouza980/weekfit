                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150"
                                                ...
                                                @if ($departamentos[0]['total_atividades'] != 0) value="{{ number_format(($departamentos[0]['total_atividades_completas'] * 100) / $departamentos[0]['total_atividades'], 1) }}" @else value="0" @endif>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150"
                                                ...
                                                @if ($departamentos[1]['total_atividades'] != 0) value="{{ number_format(($departamentos[1]['total_atividades_completas'] * 100) / $departamentos[1]['total_atividades'], 1) }}" @else value="0" @endif>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150"
                                                ...
                                                @if ($departamentos[2]['total_atividades'] != 0) value="{{ number_format(($departamentos[2]['total_atividades_completas'] * 100) / $departamentos[2]['total_atividades'], 1) }}" @else value="0" @endif>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150"
                                                ...
                                                @if ($departamentos[3]['total_atividades'] != 0) value="{{ number_format(($departamentos[3]['total_atividades_completas'] * 100) / $departamentos[3]['total_atividades'], 1) }}" @else value="0" @endif>
                                        </div>
                                    </div>
                            ...
                            @foreach (\App\Models\Grupo::where('departamento', $i)->get() as $grupo)
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="text-center" dir="ltr">
                                        ...
                                        <input class="knob" data-width="150"
                                            data-fgcolor="{{ \Functions::corDepartamento($i) }}"
                                            @if ($departamentos[$i][$grupo->nome]['total_atividades'] != 0) value="{{ number_format(($departamentos[$i][$grupo->nome]['total_atividades_completas'] * 100) / $departamentos[$i][$grupo->nome]['total_atividades'], 1) }}" @else value="0" @endif>
                                    </div>
                                </div>
                            @endforeach
                        </div>
    ...
    <script>
        ...
        option = null, option = {
            ...
            series: [{
                ...
                data: [{
                    value: "{!! number_format(($departamentos['total_atividades_completas'] * 100) / $departamentos['total_atividades']) !!}",
                    name: ""
                }]
            }]
